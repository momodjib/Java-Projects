...
public class CalculatorStep8 {

    private static Map<String, BigInteger> storedVariables = new TreeMap<>();
    ...
    private static boolean bigInt = false;
    ...
    private static void processVariables(String line){
        ...
        if(line.matches("\\w+")){
            ...
            storedVariables.put(temp[0].trim(), new BigInteger(temp[temp.length-1].trim()));
        }
    ...
    public static void computePostFix(String line){
        ...
        for(int i = 0; i < temp.length; i++){
            if(temp[i].matches("\\d+")){
                ...
                if(bigInt){
                    BigInteger a = new BigInteger((result.pop()));
                    BigInteger b = new BigInteger((result.pop()));
                    switch (temp[i]){
                        case "+":
                        ...
                        case "*":
                            ...
                            break;
                        case "-":
                            result.push(a.compareTo(b) == 1? String.valueOf(a.subtract(b)) : String.valueOf(b.subtract(a)));
                            break;
                        case "/":
                            result.push(a.compareTo(b) == 1? String.valueOf(a.divide(b)) : String.valueOf(b.divide(a)));
                            break;
                    }
                }else{
